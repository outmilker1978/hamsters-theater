...
const MENU_STR = {
  ru: {
    ...
    ourSite: 'О нас (сайт)',
    tips: 'Рекомендации и полезности',
  ...
  const appMenu = Menu.buildFromTemplate([
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: s.ourSite, click: () => { win.webContents.send('close-all-modals'); shell.openExternal('https://tvhamsters.outmilk.online'); } },
        { label: s.tips, click: () => { win.webContents.send('close-all-modals'); shell.openExternal('https://tvhamsters.outmilk.online/blog.html'); } },
        { type: 'separator' },
