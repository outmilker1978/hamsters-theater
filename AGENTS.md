...
Десктопное приложение для совместного просмотра видео онлайн: видеозвонок + трансляция экрана со звуком + голосовое общение. P2P mesh до 5 участников, i18n (RU/EN/ES), облачный и локальный режимы. Портативный single .exe для Windows.
