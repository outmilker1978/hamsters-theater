const LOCALES = {
  ru: {
    ...
    'help.scenario_tutor': 'Наставник онлайн — показываете экран, ученик повторяет. Изучение софта, радиоуправление учеником по технологии «Иди сюда, тыкай в это», обучение испанскому языку, бухать онлайн с друзьями!',
    'help.scenario_party': 'Общение с теми, кто далеко — день рождения, Новый год вместе, хоть вы и в разных городах и странах.',
