const LOCALES = {
  ru: {
    ...
    'settings.low_end_title': 'Режим слабых устройств',
    'settings.low_end_desc': 'Для старых ноутбуков и мобильных устройств. Снижает нагрузку на CPU.',
    'settings.low_end_btn_on': 'Пониженное разрешение (активно)',
    'settings.low_end_btn_off': 'Пониженное разрешение (640×360)',
    'settings.low_end_enabled': 'Режим слабых устройств включён',
    'settings.low_end_disabled': 'Режим слабых устройств выключен',
    ...
    'release.1_9_0': 'Desktop: аппаратное кодирование H.264 — видео теперь чётче и плавнее даже на слабых ПК. Адаптивный битрейт — качество само подстраивается под интернет (при плохой связи — ниже, при хорошей — выше). Режим слабых устройств — пониженное разрешение 640×360 для старых ноутбуков (включить в настройках). Telegram-бот переведён на webhook — сервер спит в простое, это экономит ~500 часов в месяц на Render. Mobile: те же улучшения видео — H.264 и низкое разрешение на слабых телефонах.',
  ...
  en: {
    ...
    'settings.low_end_title': 'Low-end Device Mode',
    'settings.low_end_desc': 'For old laptops and mobile devices. Reduces CPU load.',
    'settings.low_end_btn_on': 'Low resolution (active)',
    'settings.low_end_btn_off': 'Low resolution (640×360)',
    'settings.low_end_enabled': 'Low-end mode enabled',
    'settings.low_end_disabled': 'Low-end mode disabled',
    ...
    'name.confirm': 'Done!',
    'name.skip': 'Skip',
    'release.1_9_0': 'Desktop: hardware H.264 encoding — video is now sharper and smoother even on weak PCs. Adaptive bitrate — quality adjusts automatically to your internet (lower on bad connections, higher on good ones). Low-end device mode — reduced resolution 640×360 for old laptops (enable in Settings). Telegram bot switched to webhook — server sleeps when idle, saves ~500 hours/month on Render. Mobile: same video improvements — H.264 and low resolution on weak phones.',
  ...
  es: {
    ...
    'settings.low_end_title': 'Modo de dispositivos débiles',
    'settings.low_end_desc': 'Para portátiles antiguos y dispositivos móviles. Reduce la carga de la CPU.',
    'settings.low_end_btn_on': 'Resolución baja (activo)',
    'settings.low_end_btn_off': 'Resolución baja (640×360)',
    'settings.low_end_enabled': 'Modo de devices débiles activado',
    'settings.low_end_disabled': 'Modo de devices débiles desactivado',
    ...
    'name.confirm': '¡Listo!',
    'name.skip': 'Saltar',
    'release.1_9_0': 'Desktop: codificación H.264 por hardware — el vídeo ahora es más nítido y fluido incluso en PC débiles. Bitrate adaptativo — la calidad se ajusta automáticamente a su internet (menor en conexiones malas, mayor en buenas). Modo de dispositivos débiles — resolución reducida 640×360 para portátiles antiguos (activar en Ajustes). Bot de Telegram cambiado a webhook — el servidor duerme Cuando está inactivo, ahorra ~500 horas/mes en Render. Mobile: mismas mejoras de vídeo — H.264 y baja resolución en teléfonos débiles.',
