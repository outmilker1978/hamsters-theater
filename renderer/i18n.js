const LOCALES = {
  ru: {
    ...
    'help.desc': 'Hamsters Theater — смотрите фильмы, сериалы и видео вместе, будто вы рядом. Один включает трансляцию экрана со звуком, остальные видят видео и слышат голоса всех участников. Можно обсуждать происходящее в реальном времени, хохотать и комментировать — как в настоящем кинотеатре, только онлайн.',
    ...
    'help.team_idea': 'Идея: Хомимуми и Настя "Сеня" (спасибо за вдохновение... которое пришло ко мне, пока вы не давали мне спать)',
    ...
    'shortcut.prompt_text': 'Создать ярлык Hamsters Theater на рабочем столе для быстрого запуска?',
  ...
  en: {
    ...
    'help.desc': 'Hamsters Theater — watch movies, shows, and videos together as if you were in the same room. One person shares their screen with sound, everyone sees the video and hears all voices in real time. Laugh, comment, discuss — just like at the cinema, only online.',
    ...
    'shortcut.prompt_text': 'Create a Hamsters Theater shortcut on your desktop for quick launch?',
