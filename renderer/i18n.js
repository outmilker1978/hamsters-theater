const LOCALES = {
  ru: {
    ...
    'help.scenario_tutor': 'Наставник онлайн — показываете экран, ученик повторяет. Ремонт ПК, монтаж, настройка софта.',
    'help.scenario_party': 'Праздник с теми, кто далеко — день рождения, Новый год вместе, хоть вы и в разных городах.',
